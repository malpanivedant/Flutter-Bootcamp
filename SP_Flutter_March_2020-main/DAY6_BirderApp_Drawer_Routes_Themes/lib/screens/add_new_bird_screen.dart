...
import 'bird_list_using_card_listview_screen.dart';

class AddNewBirdWidget extends StatefulWidget {
  static const routeName = '/addnewbird';
  ...
  Widget _buildBirdId() {
    return TextFormField(
      ...
      validator: (String value) {
        if (value.isEmpty) {
          return "Id required !"; // Error !
        }
        return null; // not an error !
      },
      onSaved: (String value) {
        _txtId = int.parse(value);
      },
    );
  }
